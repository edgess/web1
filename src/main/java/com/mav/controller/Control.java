...
//	index转入，条件已设定
	public String list(Map<String, Object> map) {
		...
		page = itMapper.getAllItWithMap("A", "", "Y", "", "", "", "", 0, 20);
		map.put("page", page);
	...
	public String searchsent(String p1, String p2, String p3, String p4, String p5, String p6, String p7,
...
//		取最大id号
	...
	public String del(String id) {
		int p9i = Integer.parseInt(id);
		System.out.println(p9i);
